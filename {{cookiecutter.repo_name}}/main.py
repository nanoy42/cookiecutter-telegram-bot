...
class Bot:
    """"
    Define a wrapper for {{cookiecutter.repo_name}}. Defines handlers for commands.
    """
    ...
    def __init__(self, directory=None):
        ...
        Args:
            directory (string, optional): Where to find config.ini files. Defaults to None.
        """
        if directory:
...
if __name__ == "__main__":
    arguments = docopt(__doc__, version="{{cookiecutter.name}} {{cookiecutter.version}}")
    ...
    if debug:
        ...
        logfile = os.path.join(os.getcwd(), "{{cookiecutter.repo_name}}.log")
